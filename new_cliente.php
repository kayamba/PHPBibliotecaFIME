  ...
  <div class="container">
    <div class="row show-grid">
      <div class="alert alert-info" style="text-align: center">
        <h4>Complete los datos de su perfil para poder solicitar libros!!</h4>
      </div>
      <form role="form" action="controller/clientes.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="iduser" value="<?php echo $_SESSION['id'] ?>">
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="nombre">Nombre(s): </label>
          <input id="nombre" name="nombre" type="text" class="form-control" placeholder="Nombre(s)"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="paterno">Apellido Paterno: </label>
          <input id="paterno" name="paterno" type="text" class="form-control" placeholder="Apellido Paterno"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="materno">Apellido Materno: </label>
          <input id="materno" name="materno" type="text" class="form-control" placeholder="Apellido Materno"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="direccion">Direccion: </label>
          <input id="direccion" name="direccion" type="text" class="form-control" placeholder="Direccion"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="cp">CP: </label>
          <input id="cp" name="cp" type="number" class="form-control" placeholder="Codigo Postal"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="telefono">Telefono: </label>
          <input id="telefono" name="telefono" class="form-control" placeholder="Telefono"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="correo">Correo: </label>
          <textarea id="correo" name="correo"class="form-control" placeholder="Correo Electronico"></textarea>
        </div>
        <div class="col-md-2 col-md-offset-5">
          <button name="submit" id="submit" value="Guardar" type="submit" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
