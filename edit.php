...
<body>
  ...
  <div class="container">
    <div class="row show-grid">
      <form role="form" action="controller/edit.php" method="post" enctype="multipart/form-data">
        <input value="<?php echo $r['IdProducto']?>" id="IdProducto" name="IdProducto" type="hidden"></input>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="titulo">Titulo: </label>
          <input value="<?php echo $r['Titulo'] ?>" id="titulo" name="titulo" type="text" class="form-control" placeholder="Titulo"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="tipo">Tipo: </label>
          <input value="<?php echo $r['Tipo'] ?>" id="tipo" name="tipo" type="text" class="form-control" placeholder="Tipo"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="editorial">Editorial: </label>
          <input value="<?php echo $r['Editorial'] ?>" id="editorial" name="editorial" type="text" class="form-control" placeholder="Editorial"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="autor">Autor: </label>
          <input value="<?php echo $r['Autor'] ?>" id="autor" name="autor" type="text" class="form-control" placeholder="Autor"></input>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="cantidad">Disponibilidad: </label>
          <input value="<?php echo $r['Disponibilidad'] ?>" id="cantidad" name="cantidad" type="number" class="form-control" placeholder="Disponibilidad"></input>
        </div>
        <!-- <div class="form-group col-md-6 col-md-offset-3">
          <label for="precio">Precio: </label>
          <input value="<?php echo $r['Precio'] ?>" id="precio" name="precio" type="text" class="form-control" placeholder="Precio"></input>
        </div> -->
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="descripcion">Descripcion: </label>
          <textarea id="descripcion" name="descripcion"class="form-control" placeholder="Descripcion">
            <?php echo $r['Descripcion'] ?>
          </textarea>
        </div>
        <div class="form-group col-md-6 col-md-offset-3">
          <label for="image">Portada: </label>
          <input value="<?php echo $r['Titulo'] ?>" id="image" name="image" type="file"></input>
